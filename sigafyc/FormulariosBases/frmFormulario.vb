                        ...
                        Case sPrefijoGroupBox_
                            For Each loControl1 As Control In loControl.Controls
                                Select Case loControl1.Name.Substring(0, 3)
                                    Case sPrefijoTextBox_
                                        Dim lsValores As String = sDENE_ & sSF_ & sDEND_
                                        If InStr(lsValores, loControl1.Name.Substring(loControl1.Name.Length - 2, 2)) = 0 Then
                                            If CType(loControl1, TextBox).Text.Trim.Length > CType(loControl1, TextBox).MaxLength Then
                                                CType(loControl1, TextBox).Text = CType(loControl1, TextBox).Text.Substring(0, CType(loControl1, TextBox).MaxLength)
                                            End If
                                        End If
                                End Select
                            Next
