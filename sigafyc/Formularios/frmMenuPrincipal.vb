...
#End Region
    ...
    Private Sub MenuPrincipal_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Text = SesionActiva.datosControl(sRazonSocial_).ToString & " - Menu Principal | " & My.Application.Info.AssemblyName.ToUpper & " - Version:" & My.Application.Info.Version.Major.ToString & "." & My.Application.Info.Version.Minor.ToString & "." & My.Application.Info.Version.Revision.ToString
