...
Public Class frmFEnviarMail
    ...
    Private Sub btnAdjuntos_Click(sender As Object, e As EventArgs) Handles btnAdjuntos.Click
        ...
        Else
            ...
            Exit Sub
        End If
        LPCalcularCantidadAdjuntos()
    End Sub

    Private Sub BtnQuitar_Click(sender As Object, e As EventArgs) Handles btnQuitar.Click
        Dim loSeleccion As ListBox.SelectedObjectCollection
        loSeleccion = lstAdjuntos.SelectedItems
        For liNDX As Integer = loSeleccion.Count - 1 To 0 Step -1
            lstAdjuntos.Items.Remove(loSeleccion.Item(liNDX))
        Next
        LPCalcularCantidadAdjuntos()
    End Sub

    Private Sub LPCalcularCantidadAdjuntos()
        If lstAdjuntos.Items.Count > 0 Then
            If lstAdjuntos.Items.Count = 1 Then
                TabPage2.Text = lstAdjuntos.Items.Count.ToString & " adjunto"
            Else
                TabPage2.Text = lstAdjuntos.Items.Count.ToString & " adjuntos"
            End If
        Else
            TabPage2.Text = "Adjunto(s)"
        End If
        TabPage2.Refresh()
    End Sub
End Class