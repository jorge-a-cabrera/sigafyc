Public Class frmBss030tabcab
    Private moFormulario As frmFss030tabcab
    ...
    Private Sub LPCargarDatos()
        Dim lsSQL As String
        Dim loDatos As New Ess030tabcab
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFss030tabcab
    ...
    Private Sub btnDetalle_Click(sender As Object, e As EventArgs) Handles btnDetalle.Click
        Dim loBrowseDetalle As New frmBss040tabdet
        loBrowseDetalle.ss010_codigo = msSS010_codigo
        loBrowseDetalle.ss030_codigo = DataGridView1.Item("codigo", DataGridView1.CurrentRow.Index).Value.ToString
