Public Class frmBss070perfiles
    Private moFormulario As frmFss070perfiles
    ...
    Private Sub LPCargarDatos()
        Dim lsSQL As String
        Dim loDatos As New Ess070perfiles
        Dim loDataSet As DataSet
        Dim lsWhere As String = ""
        Dim lsCampos As String = "codigo, nombre, valido, expira, estado"
        Dim lsCamposConcat As String = "codigo, nombre"
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFss070perfiles
