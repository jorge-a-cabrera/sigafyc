Public Class frmBss050usuarios
    Private moFormulario As frmFss050usuarios
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "codigo, nombre, login, ss060_codigo as equipo, valido, expira, estado"
        Dim lsCamposConcat As String = "codigo, nombre, login"
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFss050usuarios
    ...
    Private Function LFiCantidadDetalle(ByVal psCodigo As String) As Integer
        ...
        Dim lsSQL As String = GFsGeneraSQL("Ess140bitsescab_conteo")
