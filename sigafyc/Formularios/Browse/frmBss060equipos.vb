Public Class frmBss060equipos
    Private moFormulario As frmFss060equipos
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "codigo, ubicacion, ip, mac, valido, expira, estado"
        Dim lsCamposConcat As String = "codigo, ubicacion, ip, mac"
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFss060equipos
            ...
            Case Else
                ...
                Try
                    ...
                    If loDatos.GetPK = sOk_ Then
                        ...
                        End If
                        moFormulario = New frmFss060equipos
                        moFormulario.AccessibleName = "codigo: " & loDatos.codigo
                        moFormulario.Tag = CType(sender, Button).AccessibleName
                        moFormulario.entidad = loDatos
                        GPCargar(moFormulario)
                        msLocalizar = moFormulario.AccessibleName
                ...
                Catch ex As Exception
                    GFsAvisar("Error en Browse", sError_, "No existe datos para el equipo [" & loDatos.codigo & "]" & ControlChars.CrLf & ex.Message)
                End Try
        End Select
        loDatos.CerrarConexion()
        loDatos = Nothing
