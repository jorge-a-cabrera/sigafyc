...
Public Class frmBb100vendedores
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "codvendedor as codigo, nombre, abreviado, codempresa"
        Dim lsCamposConcat As String = "codvendedor, nombre, abreviado, estado"
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFb100vendedores
            ...
            Case Else
                ...
                Try
                    loDatos.codVendedor = Integer.Parse(lsCodigo)
                    If loDatos.GetPK = sOk_ Then
                        ...
                        End If
                        moFormulario = New frmFb100vendedores
                        moFormulario.AccessibleName = "Empresa: " & loDatos.codEmpresa & ", Vendedor: " & loDatos.codVendedor
                        moFormulario.Tag = CType(sender, Button).AccessibleName
                        moFormulario.entidad = loDatos
                        GPCargar(moFormulario)
                        msLocalizar = moFormulario.AccessibleName
                ...
                Catch ex As Exception
                    GFsAvisar("Error en Browse", sError_, "No existe datos para Vendedor [" & loDatos.codVendedor & "], Empresa [" & loDatos.codEmpresa & "]" & ControlChars.CrLf & ex.Message)
                End Try
        End Select
        loDatos.CerrarConexion()
        loDatos = Nothing
    ...
    Private Function LFsTablaHashPk(ByVal psCodigo As String) As String
        ...
        If txtCodEmpresa_NE.Text.Trim.Length > 0 Then
            If psCodigo.Trim.Length > 0 Then
                Dim loDatos As New Eb100vendedores
                loDatos.codEmpresa = Integer.Parse(txtCodEmpresa_NE.Text.ToString)
                loDatos.codVendedor = Integer.Parse(psCodigo)
                Try
