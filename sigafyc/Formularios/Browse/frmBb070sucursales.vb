...
Public Class frmBb070sucursales
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCampos As String = "codsucursal as codigo, nombre, abreviado, telefono, estado, codempresa"
        Dim lsCamposConcat As String = "codsucursal, nombre, abreviado, telefono, estado"
    ...
    Private Sub LPLocalizaRegistro(ByVal psCodigo As String)
        ...
        For Each row As DataGridViewRow In DataGridView1.Rows
            ...
            If Integer.Parse(row.Cells("codigo").Value.ToString) = liCodigo Then
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFb070sucursales
            ...
            Case Else
                ...
                Try
                    loDatos.codSucursal = Integer.Parse(lsCodigo)
                    If loDatos.GetPK = sOk_ Then
                        ...
                        End If
                        moFormulario = New frmFb070sucursales
                        moFormulario.AccessibleName = "Empresa: " & loDatos.codEmpresa & ", Sucurusal: " & loDatos.codSucursal
                        moFormulario.Tag = CType(sender, Button).AccessibleName
                        moFormulario.entidad = loDatos
                        GPCargar(moFormulario)
                        msLocalizar = moFormulario.AccessibleName
                ...
                Catch ex As Exception
                    GFsAvisar("Error en Browse", sError_, "No existe datos para Sucursal [" & loDatos.codSucursal & "], Empresa [" & loDatos.codEmpresa & "]" & ControlChars.CrLf & ex.Message)
                End Try
        End Select
        loDatos.CerrarConexion()
        loDatos = Nothing
    ...
    Private Function LFsTablaHashPk(ByVal psCodigo As String) As String
        ...
        If txtCodEmpresa_NE.Text.Trim.Length > 0 Then
            If psCodigo.Trim.Length > 0 Then
                Dim loDatos As New Eb070sucursales
                loDatos.codEmpresa = Integer.Parse(txtCodEmpresa_NE.Text.ToString)
                loDatos.codSucursal = Integer.Parse(psCodigo)
                Try
    ...
    Private Sub frmBb070sucursales_Activated(sender As Object, e As EventArgs) Handles Me.Activated
