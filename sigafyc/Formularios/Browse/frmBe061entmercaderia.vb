...
Public Class frmBe061entmercaderia
    Private moFormulario As frmFe061entmercaderia
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCamposConcat As String = "orden, ubicacion, codigo, mercaderia, unidad"
        ...
        Else
            ...
            msLocalizar = ""
        End If
        lsSQL = GFsGeneraSQL("frmBe061entmercaderia")
        ...
        DataGridView1.Columns.Item("entrada").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("entrada").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("entrada").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        DataGridView1.Columns.Item("salida").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("salida").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("salida").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        DataGridView1.Columns.Item("costo").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("costo").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("costo").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        DataGridView1.Columns.Item("compra_neta").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("compra_neta").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("compra_neta").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        DataGridView1.Columns.Item("compra_impuesto").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("compra_impuesto").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("compra_impuesto").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        DataGridView1.Columns.Item("gasto_neto").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("gasto_neto").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("gasto_neto").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        DataGridView1.Columns.Item("gasto_impuesto").HeaderCell.Value.ToString.Trim()
        DataGridView1.Columns.Item("gasto_impuesto").HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight
        DataGridView1.Columns.Item("gasto_impuesto").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ...
        If miCantidad > 0 Then
            ...
            lsSQL = GFsGeneraSQL("frmBe061entmercaderia_totales")
            lsSQL = lsSQL.Replace("&codempresa", liCodEmpresa.ToString)
            ...
            Dim ldCompNeta As Decimal = Decimal.Parse(loTotales("&compneta_mb"))
            Dim ldCompImpuesto As Decimal = Decimal.Parse(loTotales("&compimpuesto_mb"))
            ...
            Dim ldTotGeneral As Decimal = ldCompNeta + ldGastNeto
            Dim ldCompNetaImp As Decimal = ldCompNeta + ldCompImpuesto
            Dim ldGastNetoImp As Decimal = ldGastNeto + ldGastImpuesto
            Dim ldTotGeneralImp As Decimal = ldCompNetaImp + ldGastNetoImp

            lblCompNeta.Text = ldCompNeta.ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            ...
            lblCompNetaImp.Text = ldCompNetaImp.ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            lblGastNetoImp.Text = ldGastNetoImp.ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            lblTotGeneralImp.Text = ldTotGeneralImp.ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
        End If
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFe061entmercaderia
    ...
    Private Sub DataGridView_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles DataGridView1.CellFormatting
        ...
        Dim loColEntrada As DataGridViewColumn = DataGridView1.Columns.Item("entrada")
        Dim loColSalida As DataGridViewColumn = DataGridView1.Columns.Item("salida")
        Dim loColCosto As DataGridViewColumn = DataGridView1.Columns.Item("costo")
        Dim loColCompraNeta As DataGridViewColumn = DataGridView1.Columns.Item("compra_neta")
        Dim loColCompraImpuesto As DataGridViewColumn = DataGridView1.Columns.Item("compra_impuesto")
        Dim loColGastoNeto As DataGridViewColumn = DataGridView1.Columns.Item("gasto_neto")
        Dim loColGastoImpuesto As DataGridViewColumn = DataGridView1.Columns.Item("gasto_impuesto")
        Dim lsFormato As String = sFormatD_ & msMaxLength

        If e.ColumnIndex = loColEntrada.Index Then
            e.Value = CInt(e.Value).ToString(sFormatF_)
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
        If e.ColumnIndex = loColSalida.Index Then
            e.Value = CInt(e.Value).ToString(sFormatF_)
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
        If e.ColumnIndex = loColCosto.Index Then
            e.Value = CInt(e.Value).ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
        If e.ColumnIndex = loColCompraNeta.Index Then
            e.Value = CDec(e.Value).ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
        If e.ColumnIndex = loColCompraImpuesto.Index Then
            e.Value = CDec(e.Value).ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
        If e.ColumnIndex = loColGastoNeto.Index Then
            e.Value = CDec(e.Value).ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
        If e.ColumnIndex = loColGastoImpuesto.Index Then
            e.Value = CDec(e.Value).ToString(sFormatC_ & miDecimales.ToString, CultureInfo.CreateSpecificCulture(msCulture))
            e.CellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            e.FormattingApplied = True
        End If
