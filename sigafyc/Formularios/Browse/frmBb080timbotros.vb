Public Class frmBb080timbotros
    Private moFormulario As frmFb080timbotros
    ...
    Private Sub LPCargarDatos()
        ...
        Dim lsCamposConcat As String = "numtimbrado, nombre, valido, expira, tipodocumento, nrodocumento"
        Dim lsCamposOcultos As String = "tipodocumento, nrodocumento"
        ...
        End If
        lsSQL = GFsGeneraSQL("frmBb080timbotros")
    ...
    Private Sub Botones_Click(sender As Object, e As EventArgs)
        ...
        Select Case CType(sender, Button).AccessibleName
            Case sAGREGAR_
                moFormulario = New frmFb080timbotros
    ...
    Private Sub btnDetalle_Click(sender As Object, e As EventArgs) Handles btnDetalle.Click
        Dim loBrowseDetalle As New frmBb081timbotros
