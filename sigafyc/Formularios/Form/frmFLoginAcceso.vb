...
Public Class frmFLoginAcceso
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Text = SesionActiva.datosControl(sRazonSocial_).ToString & " - Acceso al Sistema | " & My.Application.Info.AssemblyName.ToUpper & " - Version:" & My.Application.Info.Version.Major.ToString & "." & My.Application.Info.Version.Minor.ToString & "." & My.Application.Info.Version.Revision.ToString
