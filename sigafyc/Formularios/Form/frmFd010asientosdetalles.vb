...
Public Class frmFd010asientosdetalles
    ...
    Private Const sUltimoConcepto_ As String = "Concepto - ultimo utilizado"
            ...
            Else
                Select Case Me.Tag.ToString
                    Case sAGREGAR_
                        ...
                        loDatos.codCuenta = ttxCodCuenta.Text
                        ...
                        Dim ldImporte_mb As Decimal = Decimal.Parse(ttxImporte_mb_ND.AccessibleDescription.ToString)
                        ...
                        loDatos = Nothing
                        LPGuardarConcepto(Integer.Parse(txtCodConcepto_NE.Text.ToString), txtConcepto_AN.Text)
                    Case sMODIFICAR_
                        ...
                        If loDatos.GetPK = sOk_ Then
                            ...
                            Dim ldImporte As Decimal = Decimal.Parse(txtImporte_mo_ND.AccessibleDescription.ToString)
                            loDatos.importe_mo = Decimal.Parse(ldImporte.ToString(sFormatF_))
                            ldImporte_mb = Decimal.Parse(ttxImporte_mb_ND.AccessibleDescription.ToString)
                            loDatos.importe_mb = Decimal.Parse(ldImporte_mb.ToString(sFormatF_))
                            loDatos.codConcepto = Integer.Parse(txtCodConcepto_NE.Text.ToString)
                            loDatos.concepto = txtConcepto_AN.Text
                            If cmbEstado.Text.Trim.Length > 0 Then
    ...
    Private Sub LPGuardarConcepto(ByVal piCodConcepto As Integer, ByVal psConcepto As String)
        GPParametroGuardar(sLocal_, sUltimoConcepto_, piCodConcepto.ToString(sFormatD_ & txtCodConcepto_NE.MaxLength.ToString) & sSF_ & psConcepto.Trim)
    End Sub
        ...
        Else
            Select Case CType(sender, Control).AccessibleName
                Case "cuenta1"
                    ...
                    End If
                    ttxCodCuenta.Text = txtCuenta1_NE.Text & sSeparador_ & sCero2_ & sSeparador_ & sCero3_ & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta2"
                    msNivel = "2"
                    ...
                    End If
                    ttxCodCuenta.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & sCero3_ & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta3"
                    msNivel = "3"
                    ...
                    End If
                    ttxCodCuenta.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta4"
                    msNivel = "4"
                    ...
                    End If
                    ttxCodCuenta.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & txtCuenta4_NE.Text & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta5"
                    msNivel = "5"
                    ...
                    End If
                    ttxCodCuenta.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & txtCuenta4_NE.Text & sSeparador_ & txtCuenta5_NE.Text & sSeparador_ & sCero6_
                Case "cuenta6"
                    msNivel = "6"
                    ...
                    End If
                    ttxCodCuenta.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & txtCuenta4_NE.Text & sSeparador_ & txtCuenta5_NE.Text & sSeparador_ & txtCuenta6_NE.Text
            End Select
            ...
            If InStr(CType(sender, Control).AccessibleName, "cuenta") > 0 Then
                ...
                Else
                    ...
                    If loLookUp.entidad IsNot Nothing Then
                        ttxCodCuenta.Text = CType(loLookUp.entidad, Eb050plancuentas).codCuenta
                        lsTipoCuenta = CType(loLookUp.entidad, Eb050plancuentas).tipo
                        If lsTipoCuenta = sTotales_.Substring(0, 1) Then
                            GFsAvisar("La Cuenta [" & ttxCodCuenta.Text & "] no es IMPUTABLE", sMENSAJE_, "Los movimientos contable no puede realizarse con cuentas de TOTALES.")
                            e.Cancel = True
                            Exit Sub
                        End If
                ...
                If ttxCodCuenta.Text.Substring(0, 1) = "6" Or ttxCodCuenta.Text.Substring(0, 1) = "7" Then
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If loEmpresa.GetPK = sOk_ Then
            ...
            If loDocumento.GetPK = sOk_ Then
                If loEmpresa.codMoneda = loDocumento.codMoneda Then
                    ...
                    ttxImporte_mb_ND.Visible = False
                Else
                    lblCotizacion.Visible = True
                    lblImporte_mb.Visible = True
                    ttxImporte_mb_ND.Visible = True
                End If
            End If
        ...
        Select Case Me.Tag.ToString
            ...
            Case Else
                ...
                ttxCodCuenta.Text = CType(entidad, Ed010asientosdetalles).codCuenta
                ...
                ttxImporte_mb_ND.Text = CType(entidad, Ed010asientosdetalles).importe_mb.ToString
                ttxImporte_mb_ND.AccessibleDescription = CType(entidad, Ed010asientosdetalles).importe_mb.ToString
                ...
                txtNroAsiento_NE.Tag = sOk_
                txtCodigo_NE.Tag = sOk_
                ttxCodCuenta.Tag = sOk_
                cmbTipo.Tag = sOk_
                txtImporte_mo_ND.Tag = sOk_
                ttxImporte_mb_ND.Tag = sOk_
                txtCodConcepto_NE.Tag = sOk_
                txtConcepto_AN.Tag = sOk_
                cmbEstado.Tag = sOk_
        End Select
        ...
        ttxCodCuenta.AccessibleName = "codcuenta"
    ...
    Private Sub LPOcultaNivelesInferior(ByVal psNivel As String)
        ...
        Select Case psNivel
            ...
            Case "5"
                ...
                txtCuenta6_NE.Tag = sOk_
        End Select
        ttxCodCuenta.Visible = False
    End Sub

    Private Sub LPParseaPartesCuenta()
        txtCuenta1_NE.Text = ttxCodCuenta.Text.Substring(0, sCero1_.Length)
        txtCuenta2_NE.Text = ttxCodCuenta.Text.Substring(2, sCero2_.Length)
        txtCuenta3_NE.Text = ttxCodCuenta.Text.Substring(5, sCero3_.Length)
        txtCuenta4_NE.Text = ttxCodCuenta.Text.Substring(9, sCero4_.Length)
        txtCuenta5_NE.Text = ttxCodCuenta.Text.Substring(14, sCero5_.Length)
        txtCuenta6_NE.Text = ttxCodCuenta.Text.Substring(20, sCero6_.Length)
    End Sub
    ...
    Private Sub LPDespliegaDescripciones()
        ...
        If txtImporte_mo_ND.Text.Trim.Length > 0 Then
            ...
            ttxImporte_mb_ND.Text = ldImporte_mb.ToString(sFormatC_ & lsDecimales_b, CultureInfo.CreateSpecificCulture(lsCulture_b))
            ttxImporte_mb_ND.AccessibleDescription = ldImporte_mb.ToString '(sFormatF_ & lsDecimales_b)
        End If
        ttxImporte_mb_ND.Refresh()
    ...
    Private Sub cmbTipo_Validating(sender As Object, e As CancelEventArgs) Handles cmbTipo.Validating
        If cmbTipo.Text.Trim.Length = 0 Then
            ...
            Exit Sub
        End If
        If cmbTipo.Items.Contains(cmbTipo.Text) = False Then
            e.Cancel = True
            cmbTipo.Tag = sCancelar_
        End If
        LPDespliegaDescripciones()
    ...
    Private Sub txtConcepto_AN_Validating(sender As Object, e As CancelEventArgs) Handles txtConcepto_AN.Validating
        If txtConcepto_AN.Text.Trim.Length = 0 Then
            Dim lsConcepto As String = LFsRecuperarConcepto()
            If lsConcepto.Trim.Length = 0 Then
                txtCodConcepto_NE.Text = CType(entidadCabecera, Ee010asientoscabeceras).codConcepto.ToString
                txtConcepto_AN.Text = CType(entidadCabecera, Ee010asientoscabeceras).concepto
            Else
                Dim lsParte() As String = lsConcepto.Split(sSF_)
                txtCodConcepto_NE.Text = lsParte(0)
                txtConcepto_AN.Text = lsParte(1)
            End If
        End If
        LPDespliegaDescripciones()
    End Sub

    Private Function LFsRecuperarConcepto() As String
        Dim lsResultado As String
        lsResultado = GFsParametroObtener(sLocal_, sUltimoConcepto_)
