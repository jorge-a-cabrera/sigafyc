...
Public Class frmFb050plancuentas
            ...
            Else
                Select Case Me.Tag.ToString
                    Case sAGREGAR_
                        ...
                        loDatos.codCuenta = ttxCodigo_NE.Text
                ...
                Me.AccessibleName = ttxCodigo_NE.Text
    ...
    Private Sub ManejoEvento_Validating(sender As Object, e As CancelEventArgs)
        If CType(sender, Control).Text.Trim.Length = 0 Then
            ...
            Select Case CType(sender, Control).AccessibleName
                Case "nombre"
                    lsValorInicial = "Cuenta denominacion " & ttxCodigo_NE.Text
                Case "tipo"
        ...
        Else
            Select Case CType(sender, Control).AccessibleName
                Case "cuenta1"
                    ...
                    End If
                    ttxCodigo_NE.Text = txtCuenta1_NE.Text & sSeparador_ & sCero2_ & sSeparador_ & sCero3_ & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta2"
                    cmbNivel.Text = "2"
                    ...
                    End If
                    ttxCodigo_NE.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & sCero3_ & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta3"
                    cmbNivel.Text = "3"
                    ...
                    End If
                    ttxCodigo_NE.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta4"
                    cmbNivel.Text = "4"
                    ...
                    End If
                    ttxCodigo_NE.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & txtCuenta4_NE.Text & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "cuenta5"
                    cmbNivel.Text = "5"
                    ...
                    End If
                    ttxCodigo_NE.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & txtCuenta4_NE.Text & sSeparador_ & txtCuenta5_NE.Text & sSeparador_ & sCero6_
                Case "cuenta6"
                    cmbNivel.Text = "6"
                    ...
                    End If
                    ttxCodigo_NE.Text = txtCuenta1_NE.Text & sSeparador_ & txtCuenta2_NE.Text & sSeparador_ & txtCuenta3_NE.Text & sSeparador_ & txtCuenta4_NE.Text & sSeparador_ & txtCuenta5_NE.Text & sSeparador_ & txtCuenta6_NE.Text
            End Select
            ...
            If InStr(CType(sender, Control).AccessibleName, "cuenta") > 0 Then
                ...
                loFK1.codCuenta = ttxCodigo_NE.Text
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case Me.Tag.ToString
            Case sAGREGAR_
                ...
                ttxCodigo_NE.Text = CType(entidad, Eb050plancuentas).codCuenta
            ...
            Case Else
                ...
                Dim lsCodCuenta As String = ttxCodigo_NE.Text
    ...
    Private Sub LPParsearCodigoCuenta()
        ...
        loCuenta.codCuenta = ttxCodigo_NE.Text
        If loCuenta.GetPK = sOk_ Then
            txtNombre_AN.Text = loCuenta.nombre
            txtNombre_AN.Tag = sCancelar_
            ...
            Else
                ...
                End Select
            End If
            lsCuenta = ttxCodigo_NE.Text.Substring(0, liUltimo)
            lsCuenta = LFsSiguienteCuenta(lsCuenta, liUltimo, lsNivel)
            Select Case lsNivel
                Case "2"
                    ttxCodigo_NE.Text = lsCuenta & sSeparador_ & sCero3_ & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "3"
                    ttxCodigo_NE.Text = lsCuenta & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "4"
                    ttxCodigo_NE.Text = lsCuenta & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
                Case "5"
                    ttxCodigo_NE.Text = lsCuenta & sSeparador_ & sCero6_
                Case "6"
                    ttxCodigo_NE.Text = lsCuenta
            End Select
    ...
    Private Sub LPBloqueaNivelesInferior(ByVal psNivel As String)
        ...
        Select Case psNivel
            Case "2"
                ...
                txtCuenta2_NE.Tag = sCancelar_
            Case "3"
                txtCuenta3_NE.Enabled = True
                txtCuenta3_NE.Tag = sCancelar_
            Case "4"
                txtCuenta4_NE.Enabled = True
                txtCuenta4_NE.Tag = sCancelar_
            Case "5"
                txtCuenta5_NE.Enabled = True
                txtCuenta5_NE.Tag = sCancelar_
            Case "6"
                txtCuenta6_NE.Enabled = True
                txtCuenta6_NE.Tag = sCancelar_
        End Select
    ...
    Private Sub LPOcultaNivelesInferior(ByVal psNivel As String)
        ...
        Select Case psNivel
            ...
            Case "5"
                ...
                txtCuenta6_NE.Tag = sOk_
        End Select
        ttxCodigo_NE.Visible = False
    End Sub

    Private Sub LPParseaPartesCuenta()
        txtCuenta1_NE.Text = ttxCodigo_NE.Text.Substring(0, sCero1_.Length)
        txtCuenta2_NE.Text = ttxCodigo_NE.Text.Substring(2, sCero2_.Length)
        txtCuenta3_NE.Text = ttxCodigo_NE.Text.Substring(5, sCero3_.Length)
        txtCuenta4_NE.Text = ttxCodigo_NE.Text.Substring(9, sCero4_.Length)
        txtCuenta5_NE.Text = ttxCodigo_NE.Text.Substring(14, sCero5_.Length)
        txtCuenta6_NE.Text = ttxCodigo_NE.Text.Substring(20, sCero6_.Length)
    End Sub
    ...
    Private Sub LPDespliegaDescripciones()
        ...
        If lsCodCuenta.Trim.Length = 0 Then
            ttxCodigo_NE.Text = sCero1_ & sSeparador_ & sCero2_ & sSeparador_ & sCero3_ & sSeparador_ & sCero4_ & sSeparador_ & sCero5_ & sSeparador_ & sCero6_
        End If
