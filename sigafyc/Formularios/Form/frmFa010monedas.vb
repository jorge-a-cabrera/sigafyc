...
Public Class frmFa010monedas
        ...
        Else
            Select Case CType(sender, Control).AccessibleName
                Case "codigo"
                    ...
                    loPk = Nothing
                Case "decimales"
                    If IsNumeric(txtDecimales_NE.Text.ToString) = False Then
                        GFsAvisar("El valor ingresado [" & txtDecimales_NE.Text & "], no es un valor numerico entero.", sMENSAJE_, "Por favor corrija el valor para proseguir")
                        e.Cancel = True
                        Exit Sub
                    End If
            End Select
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case Me.Tag.ToString
            ...
            Case Else
                ...
                cmbCulture.Text = CType(entidad, Ea010monedas).culture
        ...
        cmbCulture.AccessibleName = "culture"
    ...
    Private Sub LPInicializaCultureCode()
        ...
        For Each loCInfo As CultureInfo In loCultureCodes
            If loCInfo.Name.ToString.Trim.Length > 0 Then
                If InStr(loCInfo.Name, "-") > 0 Then
                    cmbCulture.Items.Add(loCInfo.Name)
                End If
            End If
        Next
    End Sub
