...
Public Class frmFd020mercentrada
    ...
    Private msRequeridos As String() = {"codempresa", "codmercaderia", "nombre", "abreviado", "codunidad", "codclasificacion", "tipobien", "tipocosto", "inventario", "codbarra", "iva", "estado"}
            ...
            Else
                Select Case Me.Tag.ToString
                    Case sAGREGAR_
                        ...
                        loDatos.tipobien = cmbTipoBien_AN.Text
                        loDatos.tipocosto = cmbTipoCosto_AN.Text
                        loDatos.inventario = cmbInventario_AN.Text
                        loDatos.iva = cmbIva_AN.Text
            ...
            Select Case CType(sender, Control).AccessibleName
                ...
                Case "abreviado"
                    If txtNombre_AN.Text.Trim.Length > txtAbreviado_AN.MaxLength Then
                        lsValorInicial = txtNombre_AN.Text.Substring(0, txtAbreviado_AN.MaxLength)
                    Else
        ...
        Else
            Select Case CType(sender, Control).AccessibleName
                Case "codmercaderia"
                    ...
                    loPK.codmercaderia = txtCodMercaderia_AN.Text.ToString
                    If loPK.GetPK = sOk_ Then
                        Dim loParametros As New Dictionary(Of String, String)
                        loParametros.Add("&codempresa", loPK.codempresa.ToString(sFormatD_ & txtCodEmpresa_NE.MaxLength.ToString))
                        loParametros.Add("&codmercaderia", loPK.codmercaderia.ToString)
                        loParametros.Add("&nommercaderia", loPK.nombre)
                        Dim lsMensaje As String = GFsGeneraMSG("msg_frmBd020mercentrada_error_codmercaderia", loParametros)
                        GFsAvisar(lsMensaje, sMENSAJE_, "Por favor verifique el dato introducido y vuelva a intentarlo.")
                        e.Cancel = True
                        Exit Sub
                    End If
                    loPK.CerrarConexion()
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case Me.Tag.ToString
            ...
            Case Else
                ...
                cmbTipoBien_AN.Text = CType(entidad, Ed020mercentrada).tipobien
                cmbTipoCosto_AN.Text = CType(entidad, Ed020mercentrada).tipocosto
                cmbInventario_AN.Text = CType(entidad, Ed020mercentrada).inventario
                cmbIva_AN.Text = CType(entidad, Ed020mercentrada).iva
                ...
                txtCodUnidad_AN.Tag = sOk_
                txtCodClasificacion_NE.Tag = sOk_
                cmbTipoBien_AN.Tag = sOk_
                cmbTipoCosto_AN.Tag = sOk_
                cmbInventario_AN.Tag = sOk_
                cmbIva_AN.Tag = sOk_
        ...
        cmbTipoBien_AN.Enabled = True
        cmbTipoCosto_AN.Enabled = True
        cmbInventario_AN.Enabled = True
        cmbIva_AN.Enabled = True
        ...
        cmbTipoBien_AN.AccessibleName = "tipobien"
        cmbTipoCosto_AN.AccessibleName = "tipocosto"
        cmbInventario_AN.AccessibleName = "inventario"
        cmbIva_AN.AccessibleName = "iva"
    ...
    Private Sub LPInicializaMaxLength()
        ...
        cmbTipoBien_AN.MaxLength = 15
        cmbTipoCosto_AN.MaxLength = 15
        cmbInventario_AN.MaxLength = 2
        cmbIva_AN.MaxLength = 15
    ...
    Private Sub LPInicializaParametros()
        ...
        End If
        cmbTipoBien_AN.Items.Clear()
        For Each lsValor In lsCodigo.Split(sSF_)
            cmbTipoBien_AN.Items.Add(lsValor)
        Next
        If Me.Tag.ToString = sAGREGAR_ Then
            cmbTipoBien_AN.Text = cmbTipoBien_AN.Items(0).ToString
        End If
        ...
        If lsCodigo = sRESERVADO_ Then
            ...
            GPParametroGuardar(lsTipo, lsClave, lsCodigo)
        End If
        cmbTipoCosto_AN.Items.Clear()
        For Each lsValor In lsCodigo.Split(sSF_)
            cmbTipoCosto_AN.Items.Add(lsValor)
        Next
        If Me.Tag.ToString = sAGREGAR_ Then
            cmbTipoCosto_AN.Text = cmbTipoCosto_AN.Items(0).ToString
        End If
        ...
        If lsCodigo = sRESERVADO_ Then
            ...
            GPParametroGuardar(lsTipo, lsClave, lsCodigo)
        End If
        cmbInventario_AN.Items.Clear()
        For Each lsValor In lsCodigo.Split(sSF_)
            cmbInventario_AN.Items.Add(lsValor)
        Next
        If Me.Tag.ToString = sAGREGAR_ Then
            cmbInventario_AN.Text = cmbInventario_AN.Items(0).ToString
        End If

        lsClave = "d020mercentrada.iva"
        lsValor = sExenta_ & sSF_ & sGravada05_ & sSF_ & sGravada10_
        lsCodigo = GFsParametroObtener(lsTipo, lsClave)
        If lsCodigo = sRESERVADO_ Then
            lsCodigo = lsValor
            GPParametroGuardar(lsTipo, lsClave, lsCodigo)
        End If
        cmbIva_AN.Items.Clear()
        For Each lsValor In lsCodigo.Split(sSF_)
            cmbIva_AN.Items.Add(lsValor)
        Next
        If Me.Tag.ToString = sAGREGAR_ Then
            cmbIva_AN.Text = cmbIva_AN.Items(0).ToString
        End If
    End Sub
    ...
    Private Sub LPAddUnidadesAlternativas(Optional ByVal psTipo As String = sEntrada_)
        ...
        loA050.codempresa = Integer.Parse(txtCodEmpresa_NE.Text.ToString)
    ...
    Private Sub LPAddMercaderiaSalida()
        If cmbTipoBien_AN.Text = sBienUso_ Then Exit Sub
        Dim loA0601 As New Ea060clasmerc
        loA0601.codempresa = Integer.Parse(txtCodEmpresa_NE.Text.ToString)
        ...
        If loA0601.GetPK <> sOk_ Then
            ...
            loA0602.codempresa = Integer.Parse(txtCodEmpresa_NE.Text.ToString)
