    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case Me.Tag.ToString
            ...
            Case Else
                ...
                txtRuc_AN.Tag = sOk_
                txtPeriodoInicio_FE.Tag = sOk_
                txtPeriodoFinal_FE.Tag = sOk_
                txtDireccion_AN.Tag = sOk_
                txtCiudad_AN.Tag = sOk_
                txtTelefono_AN.Tag = sOk_
                txtCtaResultado1_AN.Tag = sOk_
                txtCtaResultado2__AN.Tag = sOk_
                txtCtaResultado3_AN.Tag = sOk_
                cmbEstado.Tag = sOk_
        End Select
