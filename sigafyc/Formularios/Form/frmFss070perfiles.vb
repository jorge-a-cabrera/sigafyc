...
Public Class frmFss070perfiles
    ...
    Private Sub ManejoEvento_Validating(sender As Object, e As CancelEventArgs)
        ...
        Else
            Select Case CType(sender, Control).AccessibleName
                Case "codigo"
                    Dim loPk As New Ess070perfiles
                    loPk.codigo = txtCodigo_AN.Text
                    If loPk.GetPK = sOk_ Then
                        GFsAvisar("Codigo de perfil [" & txtCodigo_AN.Text & "]", sMENSAJE_, "ya existe! Y no puede duplicarse.")
                        e.Cancel = True
                    End If
                    loPk = Nothing
    ...
    Private Sub Formulario_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Select Case Me.Tag.ToString
            ...
            Case Else
                Dim loDatos As New Ess070perfiles
                loDatos.codigo = CType(entidad, Ess070perfiles).codigo
                If loDatos.GetPK() = sOk_ Then
