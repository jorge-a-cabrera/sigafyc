Module modGFdImporte_mb
    ...
    Public Function GFdImporte_mb(ByVal piCodEmpresa As Integer, ByVal pdImporte As Decimal, ByVal psCodMoneda As String, ByVal psFecha As String, ByVal piCodDocumento As Integer) As Decimal
        Dim ldResultado As Decimal = 0.00D
        Dim lsCodMoneda_b As String = ""
        Dim liDecimal As Integer = 0
        ...
        loC020.codEmpresa = piCodEmpresa
        loC020.codDocumento = piCodDocumento
        If loC020.GetPK = sOk_ Then
            lsCotizacion = loC020.cotizacion
        End If
