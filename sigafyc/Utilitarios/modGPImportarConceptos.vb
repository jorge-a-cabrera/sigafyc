...
Module modGPImportarConceptos
    Public Sub GPImportarConceptos(ByVal piCodEmpresa As Integer)
        ...
        If String.IsNullOrEmpty(lsSeparador) Then
            ...
            Exit Sub
        End If
        GPBitacoraRegistrar(sENTRO_, "Importacion de Conceptos. Empresa: " & piCodEmpresa.ToString & ", Archivo:" & lsFileName & ", Separador:" & lsSeparador)
        ...
        Dim loTabla As New Eb020conceptos
        ...
        While True
            ...
            loTabla.codConcepto = Integer.Parse(loDato.Item("codigo").ToString)
            If loTabla.GetPK = sSinRegistros_ Then
                loTabla.codEmpresa = piCodEmpresa
                loTabla.codConcepto = Integer.Parse(loDato.Item("codigo").ToString)
                loTabla.tipo = loDato.Item("tipo").ToString
                loTabla.descripcion = loDato.Item("descripcion").ToString
            ...
            Else
                ...
                End If
                lsMensajeError &= Now.ToString(sFormatoFechaHora2_) & ": Codigo existente --> Codigo: " & loDato.Item("codigo").ToString & ", Nombre: " & loDato.Item("descripcion").ToString & ", Tipo: " & loDato.Item("tipo").ToString & ", Estado: " & loDato.Item("estado").ToString & ControlChars.CrLf
            End If
        End While
        ...
        End If
        GPBitacoraRegistrar(sSALIO_, "Importacion de Conceptos. Empresa: " & piCodEmpresa.ToString & ", Archivo:" & lsFileName & ", Separador:" & lsSeparador)
    End Sub
